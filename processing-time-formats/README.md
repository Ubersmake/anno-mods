...
Provides different formats for Processing Time values on production buildings. This defaults to adding a number for tons per minute.
...
- With tons per minute, rounded up: `01:30` -> `01:30 (0.7 t/m)`
- With tons per hour: `01:30` -> `01:30 (40 t/h)`
